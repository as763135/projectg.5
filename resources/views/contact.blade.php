    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                ...
                <a href="/performance" class="nav-item nav-link">ผลงานของเรา</a>
                <a href="/contact" class="nav-item nav-link active">ช่องทางติดต่อ</a>
   ...
   <div class="container-fluid pt-5">
        <div class="container">
            <div class="section-title position-relative text-center mx-auto mb-5 pb-3" style="max-width: 600px;">
                <h2 class="text-primary font-secondary">ช่องทางติดต่อ</h2>
                <h1 class="display-4 text-uppercase">Contact</h1>
            </div>
            ...
            <div class="row gx-5">
                <div class="col-lg-4 col-md-6 mt-lg-n5">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary border-inner p-4">
                            ...
                            <h1 class="m-0 text-uppercase text-white"></i>Promstore</h1>
                        </a>
